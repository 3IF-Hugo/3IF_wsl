...
public:
    ...
    // A move is a pair of stacks: the block on top of the first stack is moved to the top of the second stack
    ...
    //vector<State> generateNeighbors();
